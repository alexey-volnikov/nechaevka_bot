...
- История выглядит как привычный мессенджер: аватар теперь стоит рядом с именем в шапке пузыря, справа время, ниже отдельная строка с названием чата; ответы и вложения собираются в один блок без дублирования.
- Аватар и имя идут в одной линии: кружок слева, подпись автора сразу рядом без лишних рамок, чтобы визуально напоминать переписку в Telegram и убрать ощущение разнесённых фреймов.
