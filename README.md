...
- Все таблицы с чатами и историями используют еще более компактный шрифт, фиксированную сетку колонок и запрет переносов в ключевых колонках (время, чат, отправитель), поэтому заголовки и подписи всегда умещаются в одну линию; длинные значения обрезаются многоточием без роста высоты строки.
