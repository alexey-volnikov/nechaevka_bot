...
- Все таблицы с чатами и историями используют еще более компактный шрифт и запрещают переносы в ключевых колонках (время, чат, отправитель), поэтому заголовки и подписи всегда умещаются в одну линию.
