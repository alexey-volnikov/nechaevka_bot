...
- История выглядит как привычный мессенджер: аватар слева, в заголовке пузыря сразу автор и время, ниже отдельная строка с названием чата; ответы и вложения собираются в один блок без дублирования.
